<template>
    <div class="flex justify-between font-sans">
        <div class="flex justify-center p-10 bg-zinc-700">
            <div class="text-white">
                ...
                <div>
                    ...
                    <ul class="text-sm my-3">
                        ...
                        <li>
                            <a href="">
                                ...
                                vitaliybyaniskov@gmail.com
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-6 inline-block">
                                ...
                                https://github.com/AniskovVitaliy
                            </a>
                        </li>
                    </ul>
                    ...
                    <p class="pb-2 text-xl font-bold uppercase border-b-2">Skills</p>
                    <ul class="my-3 text-sm">
                        <li>PHP (Opencart, Laravel, 1C Bitrix)</li>
                        <li>JS, JQUERY</li>
                        <li>Redis</li>
                        <li class="">MySQL</li>
                        <li>Docker</li>
        ...
        <div class="p-10">
            <div class="h-[200px]">
                <h1 class="mb-3 text-6xl font-bold">Vitaliy Aniskov</h1>
                <h3 class="text-3xl">PHP developer</h3>
            </div>
            <h2 class="pb-2 mt-3 mb-3 border-black text-3xl font-bold uppercase border-b-2">Profile</h2>
            <p>
                I'm a developer with over two years of experience in commercial development. In general I work as full
                stack developer:
            </p>
            <ul class="mb-3">
                <li>Backend: native php, opencart, bitrix (a little), laravel (a little).</li>
                <li>Frontend: Js, Jquery, CSS, HTML, SCSS. I'm constantly developing and striving for high-quality, extensible and understandable code.</li>
            </ul>
            <h2 class="pb-2 mb-6 text-3xl font-bold uppercase border-b-2 border-black">Experience</h2>
            <div class="border-l-2 border-zinc-700 relative">
                ...
                <div class="pl-5 mb-3">
                    <p>01.03.2022 - until today</p>
                    <p>KSK. Homel. Belarus</p>
                    <p>Software developer</p>
                    <p>Development and support web site https://ksk.by</p>
                    <p>Technologies:</p>
                    <ul class="list-disc list-inside">
                        <li>PHP, Opencart and Laravel (a little)</li>
                        <li>JS, JQUERY, HTML, CSS</li>
                        <li>Codeception (test), Xdebug, xprof</li>
                        <li>PHPstorm, Navicat, Insomnia, GIT</li>
                    </ul>
                    <p>Responsibilities:</p>
                    <ul class="list-disc list-inside">
                        <li>Development of modules and libraries in Opencart</li>
                        <li>Developer of frontend using JS, JQUERY, CSS</li>
                        <li>Development of parser using PHPQuery</li>
                        <li>Development of tests using the Codeception framework</li>
                        <li>Profiling using xprof</li>
                        <li>Writing SQL query</li>
                    </ul>
                </div>
                <div class="pl-5 mb-3">
                    <p>01.11.2021 - 01.03.2022</p>
                    <p>Media Line Group. Homel. Belarus</p>
                    <p>Software developer</p>
                    <p>Outsourcing, development and technical support of websites on 1C Bitrix.</p>
                    <p>Technologies:</p>
                    <ul class="list-disc list-inside">
                        <li>1C-Bitrix, PHP</li>
                        <li>JS, JQUERY, HTML, CSS</li>
                    ...
                    <p>Responsibilities:</p>
                    <ul class="list-disc list-inside">
                        <li>Development components using 1C-Bitrix.</li>
                        <li>Development of parser for unloading goods from docx, xml, csv, as well as web sites.</li>
                        <li>Working with different APIs: google tag manager, google map, google analytic.</li>
                        <li>Administration 1C-Bitrix</li>
                    </ul>
                </div>
                <div class="pl-5 mb-3">
                    <p>2011 - 2020</p>
                    <p>Homselmash. Homel. Belarusian</p>
                    <ul>
                        <li>- Foreman</li>
